...
But frankly with a little effort and patience you can overcome these attempts to make it a little harder to complete the assignment
...
url = " http://py4e-data.dr-chuck.net/known_by_Kaydie.html"
